 ...
 * - ended: No longer a member — voluntary resignation (§8 p1),
 ...
 */
export const MEMBER_STATUS_VALUES = ["awaiting_payment", "awaiting_approval", "active", "ended", "rejected"] as const;
