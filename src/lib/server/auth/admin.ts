 ...
 */
export function userHasAdminAccess(user: UserWithAdminRole): boolean {
 ...
 * Use this in server code where the user may be null/undefined.
 */
export function userHasAdminWriteAccess(user: UserWithAdminRole): boolean {
 ...
 * Use this in server code where the user may be null/undefined.
 */
export function userIsReadOnlyAdmin(user: UserWithAdminRole): boolean {
