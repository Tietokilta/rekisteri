  ...
  admin: {
    ...
    settings: {
      ...
      resignation: {
        ...
        rulesUrlFi: "Organization Rules URL (FI)",
        rulesUrlEn: "Organization Rules URL (EN)",
    ...
    members: {
      ...
      table: {
        ...
        copied: "Copied!",
        export: "Export",
        exportCurrentView: "Export Current View (CSV)",
        exportSelectedRows: "Export Selected Rows (CSV) ({count})",
        customExport: "Custom Export...",
        googleGroupsSection: "Google Groups",
        stripEmailAliases: "Strip email aliases",
        exportJasenet: "Export jasenet@",
        exportAktiivit: "Export aktiivit@",
        exported: "Exported!",
        exportDialog: {
          title: "Export Members",
          filtersTitle: "Filter members",
          transformationsTitle: "Transformations",
          stripAliasesHelp: "Removes +aliases from email addresses in the CSV export only.",
          targetScope: "Rows to Export",
          allFiltered: "All members ({count})",
          selectedOnly: "Only selected members ({count})",
          noMatchingMembers: "No members match the selected filters.",
          filterYear: "Year:",
          filterType: "Membership Type:",
          filterStatus: "Status:",
          filterEmailAllowed: "Only members with email permission",
          columnsTitle: "Columns to Export",
          selectAllColumns: "Select All",
          resetColumns: "Reset Defaults",
          cancel: "Cancel",
          downloadCsv: "Download CSV",
          exportSummary: "Exporting {count} {{member|members}}",
          columns: {
            firstNames: "First Names",
            lastName: "Last Name / Organization",
            email: "Email",
        ...
        userIdLabel: "User ID:",
        emailLabel: "Email:",
        secondaryEmailsLabel: "Secondary Emails:",
        ...
        changeMembershipType: "Correct membership type",
        ...
        changeMembershipTypeTitle: "Correct membership type",
        changeMembershipTypeDescription: "Select the correct membership type for {name}.",
      ...
      cannotChangeMembershipTypeFromStatus: "Only awaiting approval or active memberships can be corrected",
      membershipTypeChangePeriodMismatch: "The membership types must belong to the same period",
      membershipTypeUnchanged: "Select a different membership type",
      membershipTypeChangeRequiresStripePrice: "Both membership types must have a Stripe price",
      membershipTypeChangePriceMismatch: "The membership types must have the same price and currency",
