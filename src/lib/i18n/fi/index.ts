	...
	admin: {
		...
		users: {
			...
			merge: {
				...
				willBeMerged: "Yhdistettävät tiedot:",
				memberships: "Jäsenyydet: {count} {{jäsenyys|jäsenyyttä}}",
				secondaryEmails: "Toissijaiset sähköpostit: {count}",
				passkeys: "Avainkoodit: {count}",
