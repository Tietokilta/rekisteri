...
{organizationName:string}`,
  ...
  admin: {
    ...
    settings: {
      ...
      resignation: {
        title: "Erottaminen & säännöt",
        rulesUrlFi: "Organisaation sääntöjen URL-osoite (FI)",
        rulesUrlEn: "Organisaation sääntöjen URL-osoite (EN)",
    ...
    members: {
      ...
      table: {
        ...
        legalMembership: "Varsinainen jäsenyys",
        feeHistory: "Jäsenmaksuhistoria",
        noFeeHistory: "Valitulta kaudelta ei ole jäsenmaksuhistoriaa",
        membershipStartedLabel: "Jäsenyys alkanut:",
        membershipEndedLabel: "Jäsenyys päättynyt:",
        obligationLabel: "Jäsenmaksuvelvoite:",
        paymentsLabel: "Maksut",
        noObligation: "Ei jäsenmaksuvelvoitetta",
        obligationRenewal: "Uusiminen",
        obligationApplication: "Jäsenhakemus",
        obligationTypeChange: "Jäsenyysluokan vaihto",
        obligationRequired: "Maksettava",
        obligationWaived: "Vapautettu",
        obligationCancelled: "Peruttu",
        paymentPending: "Odottaa maksua",
        paymentSucceeded: "Maksettu",
        paymentFailed: "Epäonnistunut",
        paymentExpired: "Vanhentunut",
        paymentInvalidated: "Mitätöity",
        paymentRefundRequired: "Hyvitettävä",
        paymentRefunded: "Hyvitetty",
        activityHistory: "Jäsenyyden tapahtumat",
        noActivityHistory: "Ei jäsenyyden tapahtumia",
        eventApplicationSubmitted: "Jäsenhakemus lähetetty",
        eventApplicationApproved: "Jäsenhakemus hyväksytty",
        eventApplicationRejected: "Jäsenhakemus hylätty",
        eventTypeChangeRequested: "Jäsenyysluokan vaihtoa haettu",
        eventTypeChanged: "Jäsenyysluokka vaihdettu",
        eventTypeChangeRejected: "Jäsenyysluokan vaihto hylätty",
        eventResignedVoluntarily: "Jäsen eronnut",
        eventDeemedResignedNonpayment: "Katsottu eronneeksi maksamattoman jäsenmaksun vuoksi",
        eventExpelled: "Jäsen erotettu",
        eventLegacyMembershipStarted: "Jäsenyys alkanut",
        eventLegacyResignation: "Jäsenyys päättynyt",
        eventLegacyRejoin: "Jäsenyys alkanut uudelleen",
        eventLegacyTypeChanged: "Jäsenyysluokka vaihdettu",
        eventMembershipDecisionCorrected: "Jäsenyyspäätös korjattu",
        eventSourceAdmin: "Hallituksen tai ylläpitäjän toimenpide",
        eventSourceSystem: "Rekisterin automatisoima",
        eventSourceImported: "Tuotu lähdeaineistosta",
        eventSourceMigration: "Päätelty migraatiossa",
        eventConfirmed: "Vahvistettu",
        eventInferred: "Päätelty",
        paymentEvent: "Jäsenmaksu",
        paymentSourceStripe: "Stripe",
        paymentSourceManual: "Kirjattu manuaalisesti",
        paymentSourceImported: "Tuotu maksutieto",

        // Actions
        approve: "Hyväksy",
        reject: "Hylkää",
        reactivate: "Aktivoi uudelleen",
        changeMembershipType: "Korjaa jäsenyysluokka",
        ...
        changeMembershipTypeTitle: "Korjaa jäsenyysluokka",
        changeMembershipTypeDescription: "Valitse oikea jäsenyysluokka jäsenelle {name}.",
      ...
      cannotChangeMembershipTypeFromStatus: "Vain hyväksyntää odottavan tai aktiivisen jäsenyyden voi korjata",
      membershipTypeChangePeriodMismatch: "Jäsenyysluokkien on oltava samalta kaudelta",
      membershipTypeUnchanged: "Valitse toinen jäsenyysluokka",
      membershipTypeChangeRequiresStripePrice: "Molemmilla jäsenyysluokilla on oltava Stripe-hinta",
      membershipTypeChangePriceMismatch: "Jäsenyysluokkien hinnan ja valuutan on oltava samat",
