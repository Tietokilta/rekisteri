  ...
  admin: {
    ...
    members: {
      ...
      table: {
        ...
        copied: "Kopioitu!",
        export: "Vie",
        exportCurrentView: "Vie nykyinen näkymä (CSV)",
        exportSelectedRows: "Vie valitut rivit (CSV) ({count})",
        customExport: "Mukautettu vienti...",
        googleGroupsSection: "Google Groups",
        stripEmailAliases: "Poista sähköpostialiakset",
        exportJasenet: "Vie jasenet@",
        exportAktiivit: "Vie aktiivit@",
        exported: "Viety!",
        exportDialog: {
          title: "Vie jäseniä",
          filtersTitle: "Rajaa jäsenet",
          transformationsTitle: "Tietojen muunnokset",
          stripAliasesHelp: "Poistaa +aliakset sähköpostiosoitteista vain CSV-viennissä.",
          targetScope: "Vietävät rivit",
          allFiltered: "Kaikki jäsenet ({count})",
          selectedOnly: "Vain valitut jäsenet ({count})",
          noMatchingMembers: "Valituilla suodattimilla ei löytynyt yhtään jäsentä.",
          filterYear: "Vuosi:",
          filterType: "Jäsentyyppi:",
          filterStatus: "Tila:",
          filterEmailAllowed: "Vain sähköpostiluvan antaneet",
          columnsTitle: "Vietävät sarakkeet",
          selectAllColumns: "Valitse kaikki",
          resetColumns: "Palauta oletukset",
          cancel: "Peruuta",
          downloadCsv: "Lataa CSV",
          exportSummary: "Viedään {count} {{jäsen|jäsentä}}",
          columns: {
            firstNames: "Etunimet",
        ...
        secondaryEmailsLabel: "Toissijaiset sähköpostit:",
