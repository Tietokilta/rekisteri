...
const ACTIONS = {
  ...
  "renewMembership /[locale=locale]": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>) }) => {
    return `/${params['locale']}?/renewMembership`
  },
