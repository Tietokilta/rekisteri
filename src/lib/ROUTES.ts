...
const PAGES = {
  ...
  "/[locale=locale]/admin/meetings/[id]/attendees": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>), id: (string | number) }) => {
    return `/${params['locale']}/admin/meetings/${params['id']}/attendees`
  },
  "/[locale=locale]/admin/meetings/[id]/scan": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>), id: (string | number) }) => {
    return `/${params['locale']}/admin/meetings/${params['id']}/scan`
  },
  ...
  "/[locale=locale]/admin/verify-qr": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>) }) => {
    return `/${params['locale']}/admin/verify-qr`
  },
 ...
 */
const SERVERS = {
  "GET /[locale=locale]/admin/meetings/[id]/attendees/export": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>), id: (string | number) }) => {
    return `/${params['locale']}/admin/meetings/${params['id']}/attendees/export`
  },
  "POST /[locale=locale]/admin/meetings/[id]/scan": (params: { locale: (ExtractParamType<typeof import('../params/locale.ts').match>), id: (string | number) }) => {
    return `/${params['locale']}/admin/meetings/${params['id']}/scan`
  },
...
export type KIT_ROUTES = {
  PAGES: { '/[locale=locale]': 'locale', '/[locale=locale]/admin/meetings': 'locale', '/[locale=locale]/admin/meetings/[id]': 'locale' | 'id', '/[locale=locale]/admin/meetings/[id]/attendees': 'locale' | 'id', '/[locale=locale]/admin/meetings/[id]/scan': 'locale' | 'id', '/[locale=locale]/admin/members': 'locale', '/[locale=locale]/admin/members/import': 'locale', '/[locale=locale]/admin/membership-types': 'locale', '/[locale=locale]/admin/memberships': 'locale', '/[locale=locale]/admin/users': 'locale', '/[locale=locale]/admin/verify-qr': 'locale', '/[locale=locale]/membership': 'locale', '/[locale=locale]/new': 'locale', '/[locale=locale]/settings/emails': 'locale', '/[locale=locale]/settings/emails/add': 'locale', '/[locale=locale]/settings/emails/verify': 'locale', '/[locale=locale]/settings/passkeys': 'locale', '/[locale=locale]/settings/profile': 'locale', '/[locale=locale]/privacy-policy': 'locale', '/[locale=locale]/sign-in': 'locale', '/[locale=locale]/sign-in/email': 'locale', '/[locale=locale]/sign-in/method': 'locale' }
  SERVERS: { 'GET /[locale=locale]/admin/meetings/[id]/attendees/export': 'locale' | 'id', 'POST /[locale=locale]/admin/meetings/[id]/scan': 'locale' | 'id', 'GET /api/health': never, 'POST /api/webhook/stripe': never }
  ACTIONS: Record<string, never>
  LINKS: Record<string, never>
  Params: { 'locale': never, 'id': never }
}
