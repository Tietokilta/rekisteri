...
CREATE INDEX "idx_oidc_entity_uid" ON "oidc_entity" ("uid");--> statement-breakpoint
CREATE INDEX "idx_oidc_entity_grant_id" ON "oidc_entity" ("grant_id");--> statement-breakpoint
CREATE INDEX "idx_oidc_entity_user_client" ON "oidc_entity" ("user_id","client_id");--> statement-breakpoint
...
ALTER TABLE "oidc_entity" ADD CONSTRAINT "oidc_entity_user_id_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE;--> statement-breakpoint
